...
<html lang="en">
  ...
  <!-- Brand Logo -->
  <a class="navbar-brand text-dark" href="index.html"><img src="<?php echo base_url();?>Images/strath.png" height="70px" width="70px">Strathmore University E-Cafe</a>
  ...
  <div class="container text-center text-md-left mt-5">
    ...
    <div class="row mt-3">
      ...
      <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
        ...
        <hr class="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style="width: 60px;">
        <p>
          <i class="fas fa-home mr-3"></i> Nairobi, NB 100, KE</p>
        <p>
          <i class="fas fa-envelope mr-3"></i> infoStrathmore@.edu</p>
        <p>
