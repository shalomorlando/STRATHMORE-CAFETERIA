...
<html lang="en">
  ...
  <!-- Brand Logo -->
  <a class="navbar-brand text-dark" href="index.html"><img src="strath.png" height="70px" width="70px">Strathmore University E-Cafe</a>
...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item active">
      <img class="d-block w-100" src="main1.jpg" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="main.jpg" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="main2.jpg" alt="Third slide">
    </div>
  </div>
...
<div class="card-deck">
  ...
  <div class="card">
    <img class="card-img-top" src="food5.jpg" alt="Card image cap">
    <div class="card-body">
  ...
  <div class="card">
    <img class="card-img-top" src="food8.jpg" alt="Card image cap">
    <div class="card-body">
  ...
  <div class="card">
    <img class="card-img-top" src="food3.png" alt="Card image cap">
    <div class="card-body">
...
<div class="card-deck">
  ...
  <div class="card">
    <img class="card-img-top" src="food4.png" alt="Card image cap">
    <div class="card-body">
  ...
  <div class="card">
    <img class="card-img-top" src="food9.jpg" alt="Card image cap" height="208px">
    <div class="card-body">
  ...
  <div class="card">
    <img class="card-img-top" src="food7.jpg" alt="Card image cap" >
    <div class="card-body">
